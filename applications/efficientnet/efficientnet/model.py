...
from tensorflow.keras.utils import get_file, get_custom_objects
...
def EfficientNet(input_shape, block_args_list, global_params, include_top=True, input_tensor=None):
    batch_norm_momentum = global_params.batch_norm_momentum
    batch_norm_epsilon = global_params.batch_norm_epsilon
    l2_reg = global_params.l2_reg
    ...
    # Stem part
    inputs = KL.Input(shape=input_shape) if input_tensor is None else KL.Input(tensor=input_tensor)
    x = inputs
    x = KL.Conv2D(
...
def _get_model_by_name(model_name, input_shape=None, include_top=True, weights=None, classes=1000, input_tensor=None):
    ...
    model = EfficientNet(input_shape, block_agrs_list, global_params, include_top=include_top, input_tensor=input_tensor)
...
def EfficientNetB0(include_top=True, input_shape=None, weights=None, classes=1000, input_tensor=None):
...
def EfficientNetB1(include_top=True, input_shape=None, weights=None, classes=1000, input_tensor=None):
    return _get_model_by_name('efficientnet-b1', include_top=include_top, input_shape=input_shape,
                              weights=weights, classes=classes, input_tensor=input_tensor)


def EfficientNetB2(include_top=True, input_shape=None, weights=None, classes=1000, input_tensor=None):
    return _get_model_by_name('efficientnet-b2', include_top=include_top, input_shape=input_shape,
                              weights=weights, classes=classes, input_tensor=input_tensor)


def EfficientNetB3(include_top=True, input_shape=None, weights=None, classes=1000, input_tensor=None):
    return _get_model_by_name('efficientnet-b3', include_top=include_top, input_shape=input_shape,
                              weights=weights, classes=classes, input_tensor=input_tensor)


def EfficientNetB4(include_top=True, input_shape=None, weights=None, classes=1000, input_tensor=None):
    return _get_model_by_name('efficientnet-b4', include_top=include_top, input_shape=input_shape,
                              weights=weights, classes=classes, input_tensor=input_tensor)


def EfficientNetB5(include_top=True, input_shape=None, weights=None, classes=1000, input_tensor=None):
    return _get_model_by_name('efficientnet-b5', include_top=include_top, input_shape=input_shape,
                              weights=weights, classes=classes, input_tensor=input_tensor)


def EfficientNetB6(include_top=True, input_shape=None, weights=None, classes=1000, input_tensor=None):
    return _get_model_by_name('efficientnet-b6', include_top=include_top, input_shape=input_shape,
                              weights=weights, classes=classes, input_tensor=input_tensor)


def EfficientNetB7(include_top=True, input_shape=None, weights=None, classes=1000, input_tensor=None):
