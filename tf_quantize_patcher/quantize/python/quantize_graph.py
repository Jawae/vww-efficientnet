...
def create_training_graph(input_graph=None, quant_delay=0, quant_type="affine"):
...
def create_eval_graph(input_graph=None, quant_type="affine"):
  ...
  Raises:
    ValueError: If elements contains an element that isn't a tf.Tensor or
      tf.Operation.
  """
  _create_graph(input_graph=input_graph, is_training=False, quant_type=quant_type)
